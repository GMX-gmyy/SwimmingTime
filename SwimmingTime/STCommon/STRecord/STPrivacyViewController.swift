...
class STPrivacyViewController: UIViewController {
    ...
    private lazy var policyScrollView: UIScrollView = {
        ...
        scrollView.contentSize = CGSize(width: stScreenWidth, height: 4200)
        return scrollView
    }()
